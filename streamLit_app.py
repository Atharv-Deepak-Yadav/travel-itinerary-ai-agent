...
def generate_mock_itinerary(dest, start_date, duration, budget_level, currency, interests):
    ...
    for i in range(duration):
        ...
        day_plan = {
            ...
            "activities": [
                {"time": "09:00 AM", "activity": morning_activity if 'morning_activity' in locals() else f"Breakfast at a highly-rated spot", "cost": f"{budget_symbol} {breakfast_cost}"},
                {"time": "11:00 AM", "activity": main_activity if 'main_activity' in locals() else f"Visit a major attraction related to {theme}", "cost": f"{budget_symbol} {museum_cost}"},
                ...
                {"time": "07:30 PM", "activity": dinner_activity if 'dinner_activity' in locals() else "Dinner with a View", "cost": f"{budget_symbol} {dinner_cost}"},
            ],
